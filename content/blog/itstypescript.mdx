...
for the sake of readability. Line 1) I installed the [ESLint GatsbyJS plugin](https://www.gatsbyjs.com/plugins/gatsby-plugin-eslint/). Line 2) I installed
ESLint and eslint-loader. Line 3) I installed the necessary types. With TypeScript,
...
"scripts": {
    ...
    "type-check:watch": "npm run type-check -- --watch", // add this too!
},
```
